---
name: speck:implement
description: "Implements a feature from a Speck specification file. Reads the spec, internalizes all requirements, prohibitions, and decision logic, then writes clean code following the reference implementation patterns. Use when user says \"implement the spec\", \"build this feature\", \"code from spec\", or after /speck has generated a spec in .claude/specs/."
argument-hint: [feature-name]
context: fork
disable-model-invocation: true
compatibility: "Requires .NET/C# project with an existing Speck specification in .claude/specs/."
metadata:
  version: 1.0.0
---

# Implement Feature from Speck Specification

You are implementing a feature from a specification generated by `/speck`. Your goal is to write clean, idiomatic code that follows the project's established patterns — as if you were a developer who simply knew the domain.
...
- If no spec exists, tell the developer to run `/speck $ARGUMENTS` first
